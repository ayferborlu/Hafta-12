...
public class BookBorrowingService {
    ...
    public BookBorrowingService(BookBorrowingRepository _bookBorrowingRepo, BookService _bookService, BookBorrowingMapper _bookBorrowingMapper) {
        bookBorrowingMapper = _bookBorrowingMapper;
        bookService = _bookService;
        bookBorrowingRepository = _bookBorrowingRepo;
    }
